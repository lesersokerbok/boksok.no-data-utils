...
function imageItemForBook(bookID, imageItemId) {
    ...
    var url = 'https://raw.githubusercontent.com/lesersokerbok/boksok.no-data-utils/develop/output/01-15/images/'
...
function convertToXML(books) {
    return new Promise(function (resolve, reject) {
        ...
        _.each(books, function (book) {
            ...
            _.each(book.lsb_tax_lsb_cat, function (lsb_cat) {
              item.push({
                  category: {
                      _attr: { domain: "lsb_tax_lsb_cat", nicename: niceName(lsb_cat) },
                      _cdata: lsb_cat
                  }
              });
            });
            ...
            var imageItemId = 15000 + imageItemCounter++,
